...
import com.example.aexpress.activities.LoginActivity;
...
//        firebaseDatabase=FirebaseDatabase.getInstance().getReference("CreateUser");
        binding=FragmentProfileBinding.inflate(getLayoutInflater());
        FirebaseDatabase.getInstance().getReference("NewUsers").child(auth.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
